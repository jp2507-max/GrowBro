  ...
  tables: [
    ...
    tableSchema({
      ...
      columns: [
        ...
        { name: 'triggered_at', type: 'string', isIndexed: true },
        { name: 'delivered_at_local', type: 'string', isOptional: true },
    ...
    tableSchema({
      ...
      columns: [
        ...
        { name: 'reservoir_id', type: 'string', isOptional: true },
        { name: 'plant_id', type: 'string', isOptional: true },
        { name: 'fed_at', type: 'string', isIndexed: true },
