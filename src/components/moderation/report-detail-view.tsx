...
import type { ConflictOfInterest, ModerationReport } from '@/types/moderation';
...
export function ReportDetailView({
  ...
  const reportCategory = report.category || 'General';
  const reporterType = report.reporter_type || 'User';
