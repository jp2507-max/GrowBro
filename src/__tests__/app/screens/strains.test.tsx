...
import StrainsScreen from '@/app/(app)/(index,community,strains,calendar)/strains';
...
jest.mock('@/api', () => ({
  useStrainsInfinite: (...args: unknown[]) => mockStrainsInfinite(...args),
}));
