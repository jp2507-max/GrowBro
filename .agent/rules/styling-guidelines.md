...
- **Tokens**: [src/components/ui/colors.js](cci:7://file:///c:/Users/Peter/GrowBro/src/components/ui/colors.js:0:0-0:0) → Tailwind config.
  - Palettes: `primary`, `neutral`, `charcoal`, [ink](cci:2://file:///c:/Users/Peter/GrowBro/src/lib/theme-tokens.ts:22:0-25:2), `terracotta`, `sky`, `indigo`, `success`, `warning`, `danger`.
  - Prefer tokens (`bg-primary-600`, `text-ink-900`) over raw hex.
- **Fonts**: `font-inter` default; override via classNames.
- **Dark mode**: `darkMode: 'class'`. Runtime theming via [src/lib/nativewind-theme-provider.tsx](cci:7://file:///c:/Users/Peter/GrowBro/src/lib/nativewind-theme-provider.tsx:0:0-0:0).
- **Variants**: `tailwind-variants` `tv()`; static layout in slots, variants for tokens.
- **SVG**: `cssInterop` enables `className` (see [src/components/ui/index.tsx](cci:7://file:///c:/Users/Peter/GrowBro/src/components/ui/index.tsx:0:0-0:0)).
...
- **Palette**: [src/components/ui/colors.js](cci:7://file:///c:/Users/Peter/GrowBro/src/components/ui/colors.js:0:0-0:0) → shared by Tailwind & runtime.
- **Runtime**: [src/lib/nativewind-theme-provider.tsx](cci:7://file:///c:/Users/Peter/GrowBro/src/lib/nativewind-theme-provider.tsx:0:0-0:0) injects CSS vars via `vars()`.
...
- **JS tokens**: [src/lib/theme-tokens.ts](cci:7://file:///c:/Users/Peter/GrowBro/src/lib/theme-tokens.ts:0:0-0:0) → raw values for React Navigation & native `style` props. Keep in sync with [nativewind-theme-provider.tsx](cci:7://file:///c:/Users/Peter/GrowBro/src/lib/nativewind-theme-provider.tsx:0:0-0:0).
